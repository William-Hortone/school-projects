...
import { BedMoreDetails, MedicineDetails, OutPTreatmentDetails } from "../..";
import axios from "axios";
import MedicineCDetails from "../MedicineCDetails/MedicineCDetails";
import MedicineOrderDetails from "../medicineOrderDeails/MedicineOrderDetails";
...
const MedicineOrder = () => {
  ...
  return (
    <div className="appScheduling">
      <h2 className="page-title"> MEDICINE ORDER </h2>
      <div className="appScheduling-container">
        <div className="details-title">
          <h4>Medicine infos</h4>
